...
<%--     <script src="<c:url value="/resources/bower_components/jquery/jquery.min.js" />"></script> --%>
    ...
    <script type="text/javascript" src="<c:url value="/resources/js/jquery.ui.position.min.js" />" ></script>
		    ...
		    <div class="row">
		        ...
		        <div id="content" class="col-lg-10 col-sm-10">
		            ...
		            <div>
						<ul class="breadcrumb">
							<li>
								<a href="professor_index.html">Home</a>
							</li>
							<li>
								<a href="professor_index.html">Index</a>
							</li>
						</ul>
					</div>
